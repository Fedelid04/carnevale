...
<body>
    <div class='flexContainer'>
        <section class='navbar'>
            <div class='home'><a class='opzione' href="aggiungiImmagine.php"> GALLERIA MASCHERE</a></div>
            <hr>
            </hr>
            <div class='ricerca'>
            ...
            <div class='nuovoCliente'>
                <a href='./maschera/galleriaMaschere.php'><button>galleria</button></a>
            </div>
            ...
            <div class='listaClienti'>
                <ul id='clientiElenco'>
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        echo "<li><ion-icon name='arrow-forward-outline'></ion-icon><a id='numero maschera: " . $row['nMaschera'] . "' class='opzione cliente " . $row['nMaschera'] . "' href='aggiungiImmagine.php?";
                        echo "nMaschera=";
                        echo $row['nMaschera'];
...
<fieldset class="fieldsetSocioRegistrazione" style="width: 1050px; height: 1515px; color:black;  transform: translateX(20px);">';
                            ...
                            echo '  <h1>aggiungi immagine</h1>
<hr style="transform: translateY(15px); color:black; height:3px;">
<br> <br>';


                            echo ' <label for="nMaschera" >  numero maschera:</label>
...
<option value=""> </option>';
                            ...
                            try {
                                include "../conn.php";
                                $sql = "SELECT * from maschera WHERE nMaschera NOT IN (SELECT nMaschera FROM galleria);";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                            ...
                            echo '<br><br> <label for="image" >   immagine maschera:</label>
';
                            ...
                            echo '   <br><br> <div class="file-input">
...
<p class="file-name"></p>
          ...
          <div><input type="submit" value="registra " name="submit" class="submit" id="registrazione" style=" transform: translateY(-10px); font-size:20px; height: 30px;"> </div>

';


                            echo '  
<a style="color:deepskyblue; font-size:25px; background:white; border-radius:5px;" href="eliminaImmagine.php">elimina</a>  ';
