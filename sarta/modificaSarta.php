  ...
  <section class="home-section">
    ...
    <div class="home-content">
      ...
      try {
        ...
        $sql = "SELECT * FROM sarta WHERE codiceSarta='$codiceSarta';";
      ...
      <div style="transform: translateY(360px);">
        ...
        <div class="" style="transform: translateX(320px); width: 720px; height: 620px;">
          <?php
          $codiceSarta = $_GET['codiceSarta'];

          echo '<form action="cambioSarta.php?codiceSarta=' . $codiceSarta . '" method="post">';
          ?>

          <fieldset class="fieldsetSocioRegistrazione" style=" width: 1200px;">
            <?php
            if (isset($_GET['errore'])) {
              $errore = $_GET['errore'];

              if ($errore == 1) {
                echo "<br><div class='errore' style=' width: 400px;'>sarta già registrata</div><br>";
              }
            }
            ?>
            <legend style=" font-weight: 400; color: black; background:white; width:490px;">credenziali sarta nuove</legend>

            <br>
            <br>

            <label for="nome">nome sarta:</label>
            <input type="text" id="nome" placeholder="nome" name="nome" maxlength="50">
            <br>
            <br>

            <label for="costo">costo all'ora:</label>
            <input type="number" min="0" id="costo" placeholder="costo" name="costo" maxlength="50">
            ...
            <div><input style="margin-bottom:5px;" type="submit" value="invia" class='submit' id="inviaEmail">
            </div>

            <a style="color:deepskyblue; font-size:25px; background:white; border-radius:5px;" href="aggiungiSarta.php">registra</a>
            <a style="color:deepskyblue; font-size:25px; background:white; border-radius:5px;" href="impostazioniSarta.php">elimina</a>
