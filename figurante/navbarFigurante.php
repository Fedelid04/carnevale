        ...
        <section class="top-nav">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="gestioneFiguranti.php">aggiungi figurante</a>
                    <a class="dropdown-item" href="impostazioniFigurante.php">modifica figurante</a>
                    <a class="dropdown-item" href="figuranteElimina.php">elimina figurante</a>
                </div>
                </li>
            </div>
            <div class="btn-group">
