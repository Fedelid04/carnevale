...
<form action="eliminaCarica.php" method="post" name="form" id="form" class=""  style=" transform: translateY(350px);">
   ...
   <fieldset class="fieldsetSocioRegistrazione" style="width: 720px;
    ...
    <?php
       if (isset($_GET['errore'])) {
           ...
           if($errore==1){
                echo "<br><div class='errore' style=' width: 600px;'>carica già registrata </div><br>";
           }elseif ($errore==2) {
               echo "<br><div class='errore' style=' width: 600px;'>codice di carica già registrato </div><br>";
           }
       }                   
   ?>
   <h1>ELIMINA CARICA</h1>
 ...
 <select id="codiceCarica" style="transform: translateX(-17px);" name="codiceCarica" required>
 <option value=''> </option>
 <?php
 ...
 echo ' <option value='.$row['codiceCarica'].'>'.$row['codiceCarica'].' carica: '.$row['carica'].'</option>';
 }
...
<div><input type="submit" value="elimina" class='submit delete' id="registrazione"></div>
 
<input type="reset" name="cancella" value="Annulla"> </div>
