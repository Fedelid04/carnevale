        ...
        <section class="top-nav">
            <div class="btn-group">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="reportSocio.php">report socio</a>
                    <a class="dropdown-item" href="registraSocio.php">registrazione socio</a>
                    <a class="dropdown-item" href="impostazioniSocio.php">modifica socio</a>
                    <a class="dropdown-item" href="SocioElimina.php">elimina socio</a>
                </div>
            </div>
            <div class="btn-group">
                <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="reportSocio.php">report soci </a>
