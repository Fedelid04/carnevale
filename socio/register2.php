...
$numeroRicevuta=$_POST['ricevuta'];
      ...
      if ($totale == 1) {
       ...
       if ($totale == 1) {
           ...
           if ($totale == 1) {
            ...
            if($cf2==""){
                $query="INSERT INTO sociminorenni VALUES('$codiceSocio','$cf',NULL);";
                $stmt = $con->prepare($query);
                $stmt->execute();
                
            }else{
                 $query="INSERT INTO sociminorenni VALUES('$codiceSocio','$cf','$cf2');";
                 $stmt = $con->prepare($query);
                 $stmt->execute();
            }
            ...
            $stmt->execute();
             ...
             if ($figurante=="si") {
                if($nMaschera=="nessuna"){
                    $query = "INSERT INTO figuranti(codSocio,mascheraBase,mascheraRecupero) VALUES('$codiceSocio','N/A','N/A');
                    ";
 ...
 echo $query;
      ...
      header("Location: registraSocio2.php", true, 301);
     exit();
       }
       }
