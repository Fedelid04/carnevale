...
<body>
  ...
  <div class="container">
    <h3 style="text-align: center;">REGISTRAZIONE MINORENNE</h3>
    <form action="register2.php" method="post" name="form" id="form" class="">
      <div class="form-row">
        ...
        <div class="form-group col-sm-2">
          <label for="">CF2</label>
          <input name="cf2" type="text" class="form-control" placeholder="Codice Fiscale Genitore 2">
        </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-2">
          <br>
          <label></label>
          <input type="submit" value="Registra" class="form-control" id="Registra">
        </div>
      </div>
    </form>
  </div>
